    ...
    return MaterialApp(
     home: Scaffold(
      ...
      body : ListView(
        ...
        Container(
          child : Image.network('https://i2-prod.football.london/incoming/article19603985.ece/ALTERNATES/s615/1_GettyImages-1292162465.jpg')
        ),
         Container(
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Container(
                      ...
                      alignment: Alignment.center,
                      child: Text(
                        "pique bilang wasit untungkan madrid, koeman tepok jidat", style: TextStyle(color: Colors.black),
                      ),
                      height: 100,
                      width: 150,
                    ),
